...
def save_pt(dataset: SupervisedDataset, save_path: str):
...
if __name__ == '__main__':
    ...
    data_path = '/home/jovyan/workspace/data/openthought_evol-221k.json'
    ds = make_supervised_data_module(tokenizer, data_path)
    save_pt(ds['train_dataset'],'/home/jovyan/workspace/z1/data/qwen-221k')
